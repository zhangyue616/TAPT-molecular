...
def add_train_args(parser: ArgumentParser):
    ...
    parser.add_argument('--use_tapt', action='store_true', default=False,
                        help='Enable TAPT (Task-Aware Prompting). ')
...
def modify_train_args(args: Namespace):
    ...
    if args.use_tapt:
        ...
        print("\n🚀 [Config] Activated: Baseline (Functional Prompt)\n")

    if not args.freeze_encoder and args.backbone_lr >= args.prompt_lr and args.use_tapt:
        import warnings
